...
export default function HeroContent() {
  return (
    <div className="relative z-20 w-full px-4 sm:px-5 md:px-6 lg:px-7 xl:px-8 2xl:px-10">
      <div className="mx-auto flex w-full max-w-4xl flex-col items-center gap-4 text-center sm:gap-5 md:gap-6">
        <h1 className="text-4xl font-medium tracking-tight text-primary sm:text-5xl md:text-6xl lg:text-[4.25rem]">
          Think Candid
        </h1>

        <div className="max-w-3xl px-6 py-4 sm:px-8 sm:py-5">
        ...
        <ViewTransition name="hero-cta" share="morph">
          ...
          >
            ...
            <span className="relative z-10">Open the Candid Deck</span>
          </a>
        </ViewTransition>
      </div>
    </div>
